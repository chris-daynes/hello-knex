...
function updateStudent (student, callback) {
  return knex('students').update({name: student.name, cohort: student.cohort}).asCallback(callback)
}
...
updateStudent({id: 11, name: 'Chris Daynes', cohort: 'Piwakawaka-2016'}, function (err, res) {
  if (err) return console.log(err)
  console.log(res)
})
